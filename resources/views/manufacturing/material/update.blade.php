                      ...
                      <form action="{{ route('material.update', $material->id) }}" method="POST"
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="name" class="form-control"
                                      placeholder="Masukkan nama material" value="{{ $material->name }}" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="code" class="form-control"
                                      placeholder="Contoh: MAT-001"value="{{ $material->code }}" required>
                              </div>
                          </div>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  @if ($material->image)
                                      <div class="mb-2">
                                          <img src="{{ asset('storage/' . $material->image) }}" width="120"
